...
#if defined(MATHC_USE_INT)
bool vec2i_is_zero(mint_t *v0) { return v0[0] == 0 && v0[1] == 0; }
...
mfloat_t vec2_angle(mfloat_t *v0) { return MATAN2(v0[1], v0[0]); }
...
mfloat_t *vec3_rotate(mfloat_t *result, mfloat_t *v0, mfloat_t *ra,
  ...
  ry = ra[1];
  rz = ra[2];
  result[0] = x * (cs + rx * rx * (1 - cs)) +
              y * (rx * ry * (1 - cs) - rz * sn) +
              z * (rx * rz * (1 - cs) + ry * sn);
  result[1] = x * (ry * rx * (1 - cs) + rz * sn) +
              y * (cs + ry * ry * (1 - cs)) +
              z * (ry * rz * (1 - cs) - rx * sn);
...
mfloat_t *mat4_perspective(mfloat_t *result, mfloat_t fov_y, mfloat_t aspect,
...
#if defined(MATHC_USE_INT)
bool svec2i_is_zero(struct vec2i v0) { return vec2i_is_zero((mint_t *)&v0); }
...
bool svec3i_is_zero(struct vec3i v0) { return vec3i_is_zero((mint_t *)&v0); }
...
bool svec4i_is_zero(struct vec4i v0) { return vec4i_is_zero((mint_t *)&v0); }
...
#if defined(MATHC_USE_FLOATING_POINT)
bool svec2_is_zero(struct vec2 v0) { return vec2_is_zero((mfloat_t *)&v0); }
...
struct vec2 svec2_bezier3(struct vec2 v0, struct vec2 v1, struct vec2 v2,
                          mfloat_t f) {
  struct vec2 result;
  vec2_bezier3((mfloat_t *)&result, (mfloat_t *)&v0, (mfloat_t *)&v1,
               (mfloat_t *)&v2, f);
  return result;
}
...
struct vec2 svec2_bezier4(struct vec2 v0, struct vec2 v1, struct vec2 v2,
  ...
  struct vec2 result;
  vec2_bezier4((mfloat_t *)&result, (mfloat_t *)&v0, (mfloat_t *)&v1,
               (mfloat_t *)&v2, (mfloat_t *)&v3, f);
  return result;
}

mfloat_t svec2_angle(struct vec2 v0) { return vec2_angle((mfloat_t *)&v0); }

mfloat_t svec2_length(struct vec2 v0) { return vec2_length((mfloat_t *)&v0); }
...
bool svec3_is_zero(struct vec3 v0) { return vec3_is_zero((mfloat_t *)&v0); }
...
struct vec3 svec3_bezier3(struct vec3 v0, struct vec3 v1, struct vec3 v2,
                          mfloat_t f) {
  struct vec3 result;
  vec3_bezier3((mfloat_t *)&result, (mfloat_t *)&v0, (mfloat_t *)&v1,
               (mfloat_t *)&v2, f);
  return result;
}
...
struct vec3 svec3_bezier4(struct vec3 v0, struct vec3 v1, struct vec3 v2,
  ...
  struct vec3 result;
  vec3_bezier4((mfloat_t *)&result, (mfloat_t *)&v0, (mfloat_t *)&v1,
               (mfloat_t *)&v2, (mfloat_t *)&v3, f);
  return result;
}

mfloat_t svec3_length(struct vec3 v0) { return vec3_length((mfloat_t *)&v0); }
...
bool svec4_is_zero(struct vec4 v0) { return vec4_is_zero((mfloat_t *)&v0); }
...
bool squat_is_zero(struct quat q0) { return quat_is_zero((mfloat_t *)&q0); }
...
mfloat_t squat_length(struct quat q0) { return quat_length((mfloat_t *)&q0); }
...
struct mat4 smat4(mfloat_t m11, mfloat_t m12, mfloat_t m13, mfloat_t m14,
  ...
  struct mat4 result;
  mat4((mfloat_t *)&result, m11, m12, m13, m14, m21, m22, m23, m24, m31, m32,
...
struct mat4 smat4_look_at(struct vec3 position, struct vec3 target,
                          struct vec3 up) {
  struct mat4 result;
  mat4_look_at((mfloat_t *)&result, (mfloat_t *)&position, (mfloat_t *)&target,
               (mfloat_t *)&up);
  return result;
}
...
#if defined(MATHC_USE_INT)
bool psvec2i_is_zero(struct vec2i *v0) { return vec2i_is_zero((mint_t *)v0); }
...
struct vec2i *psvec2i_subtract(struct vec2i *result, struct vec2i *v0,
                               struct vec2i *v1) {
  return (struct vec2i *)vec2i_subtract((mint_t *)result, (mint_t *)v0,
                                        (mint_t *)v1);
}
...
struct vec2i *psvec2i_multiply(struct vec2i *result, struct vec2i *v0,
                               struct vec2i *v1) {
  return (struct vec2i *)vec2i_multiply((mint_t *)result, (mint_t *)v0,
                                        (mint_t *)v1);
}
...
bool psvec3i_is_zero(struct vec3i *v0) { return vec3i_is_zero((mint_t *)v0); }
...
struct vec3i *psvec3i_subtract(struct vec3i *result, struct vec3i *v0,
                               struct vec3i *v1) {
  return (struct vec3i *)vec3i_subtract((mint_t *)result, (mint_t *)v0,
                                        (mint_t *)v1);
}
...
struct vec3i *psvec3i_multiply(struct vec3i *result, struct vec3i *v0,
                               struct vec3i *v1) {
  return (struct vec3i *)vec3i_multiply((mint_t *)result, (mint_t *)v0,
                                        (mint_t *)v1);
}
...
bool psvec4i_is_zero(struct vec4i *v0) { return vec4i_is_zero((mint_t *)v0); }
...
struct vec4i *psvec4i_subtract(struct vec4i *result, struct vec4i *v0,
                               struct vec4i *v1) {
  return (struct vec4i *)vec4i_subtract((mint_t *)result, (mint_t *)v0,
                                        (mint_t *)v1);
}
...
struct vec4i *psvec4i_multiply(struct vec4i *result, struct vec4i *v0,
                               struct vec4i *v1) {
  return (struct vec4i *)vec4i_multiply((mint_t *)result, (mint_t *)v0,
                                        (mint_t *)v1);
}
...
#if defined(MATHC_USE_FLOATING_POINT)
bool psvec2_is_zero(struct vec2 *v0) { return vec2_is_zero((mfloat_t *)v0); }
...
struct vec2 *psvec2_subtract(struct vec2 *result, struct vec2 *v0,
                             struct vec2 *v1) {
  return (struct vec2 *)vec2_subtract((mfloat_t *)result, (mfloat_t *)v0,
                                      (mfloat_t *)v1);
}
...
struct vec2 *psvec2_multiply(struct vec2 *result, struct vec2 *v0,
                             struct vec2 *v1) {
  return (struct vec2 *)vec2_multiply((mfloat_t *)result, (mfloat_t *)v0,
                                      (mfloat_t *)v1);
}
...
struct vec2 *psvec2_multiply_mat2(struct vec2 *result, struct vec2 *v0,
                                  struct mat2 *m0) {
  return (struct vec2 *)vec2_multiply_mat2((mfloat_t *)result, (mfloat_t *)v0,
                                           (mfloat_t *)m0);
}

struct vec2 *psvec2_divide(struct vec2 *result, struct vec2 *v0,
                           struct vec2 *v1) {
  return (struct vec2 *)vec2_divide((mfloat_t *)result, (mfloat_t *)v0,
                                    (mfloat_t *)v1);
}
...
struct vec2 *psvec2_clamp(struct vec2 *result, struct vec2 *v0, struct vec2 *v1,
                          struct vec2 *v2) {
...
struct vec2 *psvec2_project(struct vec2 *result, struct vec2 *v0,
                            struct vec2 *v1) {
  return (struct vec2 *)vec2_project((mfloat_t *)result, (mfloat_t *)v0,
                                     (mfloat_t *)v1);
}
...
struct vec2 *psvec2_reflect(struct vec2 *result, struct vec2 *v0,
                            struct vec2 *normal) {
  return (struct vec2 *)vec2_reflect((mfloat_t *)result, (mfloat_t *)v0,
                                     (mfloat_t *)normal);
}
...
struct vec2 *psvec2_lerp(struct vec2 *result, struct vec2 *v0, struct vec2 *v1,
                         mfloat_t f) {
...
struct vec2 *psvec2_bezier3(struct vec2 *result, struct vec2 *v0,
  ...
  return (struct vec2 *)vec2_bezier3((mfloat_t *)result, (mfloat_t *)v0,
                                     (mfloat_t *)v1, (mfloat_t *)v2, f);
}

struct vec2 *psvec2_bezier4(struct vec2 *result, struct vec2 *v0,
                            struct vec2 *v1, struct vec2 *v2, struct vec2 *v3,
                            mfloat_t f) {
  return (struct vec2 *)vec2_bezier4((mfloat_t *)result, (mfloat_t *)v0,
                                     (mfloat_t *)v1, (mfloat_t *)v2,
                                     (mfloat_t *)v3, f);
}

mfloat_t psvec2_angle(struct vec2 *v0) { return vec2_angle((mfloat_t *)v0); }

mfloat_t psvec2_length(struct vec2 *v0) { return vec2_length((mfloat_t *)v0); }
...
bool psvec3_is_zero(struct vec3 *v0) { return vec3_is_zero((mfloat_t *)v0); }
...
struct vec3 *psvec3_subtract(struct vec3 *result, struct vec3 *v0,
                             struct vec3 *v1) {
  return (struct vec3 *)vec3_subtract((mfloat_t *)result, (mfloat_t *)v0,
                                      (mfloat_t *)v1);
}
...
struct vec3 *psvec3_multiply(struct vec3 *result, struct vec3 *v0,
                             struct vec3 *v1) {
  return (struct vec3 *)vec3_multiply((mfloat_t *)result, (mfloat_t *)v0,
                                      (mfloat_t *)v1);
}
...
struct vec3 *psvec3_multiply_mat3(struct vec3 *result, struct vec3 *v0,
                                  struct mat3 *m0) {
  return (struct vec3 *)vec3_multiply_mat3((mfloat_t *)result, (mfloat_t *)v0,
                                           (mfloat_t *)m0);
}

struct vec3 *psvec3_divide(struct vec3 *result, struct vec3 *v0,
                           struct vec3 *v1) {
  return (struct vec3 *)vec3_divide((mfloat_t *)result, (mfloat_t *)v0,
                                    (mfloat_t *)v1);
}
...
struct vec3 *psvec3_clamp(struct vec3 *result, struct vec3 *v0, struct vec3 *v1,
                          struct vec3 *v2) {
...
struct vec3 *psvec3_project(struct vec3 *result, struct vec3 *v0,
                            struct vec3 *v1) {
  return (struct vec3 *)vec3_project((mfloat_t *)result, (mfloat_t *)v0,
                                     (mfloat_t *)v1);
}
...
struct vec3 *psvec3_reflect(struct vec3 *result, struct vec3 *v0,
                            struct vec3 *normal) {
  return (struct vec3 *)vec3_reflect((mfloat_t *)result, (mfloat_t *)v0,
                                     (mfloat_t *)normal);
}
...
struct vec3 *psvec3_lerp(struct vec3 *result, struct vec3 *v0, struct vec3 *v1,
                         mfloat_t f) {
  return (struct vec3 *)vec3_lerp((mfloat_t *)result, (mfloat_t *)v0,
                                  (mfloat_t *)v1, f);
}
...
struct vec3 *psvec3_bezier3(struct vec3 *result, struct vec3 *v0,
  ...
  return (struct vec3 *)vec3_bezier3((mfloat_t *)result, (mfloat_t *)v0,
                                     (mfloat_t *)v1, (mfloat_t *)v2, f);
}

struct vec3 *psvec3_bezier4(struct vec3 *result, struct vec3 *v0,
                            struct vec3 *v1, struct vec3 *v2, struct vec3 *v3,
                            mfloat_t f) {
  return (struct vec3 *)vec3_bezier4((mfloat_t *)result, (mfloat_t *)v0,
                                     (mfloat_t *)v1, (mfloat_t *)v2,
                                     (mfloat_t *)v3, f);
}

mfloat_t psvec3_length(struct vec3 *v0) { return vec3_length((mfloat_t *)v0); }
...
bool psvec4_is_zero(struct vec4 *v0) { return vec4_is_zero((mfloat_t *)v0); }

bool psvec4_is_equal(struct vec4 *v0, struct vec4 *v1) {
  return vec4_is_equal((mfloat_t *)v0, (mfloat_t *)v1);
}

struct vec4 *psvec4(struct vec4 *result, mfloat_t x, mfloat_t y, mfloat_t z,
                    mfloat_t w) {
...
struct vec4 *psvec4_subtract(struct vec4 *result, struct vec4 *v0,
                             struct vec4 *v1) {
  return (struct vec4 *)vec4_subtract((mfloat_t *)result, (mfloat_t *)v0,
                                      (mfloat_t *)v1);
}
...
struct vec4 *psvec4_multiply(struct vec4 *result, struct vec4 *v0,
                             struct vec4 *v1) {
  return (struct vec4 *)vec4_multiply((mfloat_t *)result, (mfloat_t *)v0,
                                      (mfloat_t *)v1);
}
...
struct vec4 *psvec4_multiply_mat4(struct vec4 *result, struct vec4 *v0,
                                  struct mat4 *m0) {
  return (struct vec4 *)vec4_multiply_mat4((mfloat_t *)result, (mfloat_t *)v0,
                                           (mfloat_t *)m0);
}

struct vec4 *psvec4_divide(struct vec4 *result, struct vec4 *v0,
                           struct vec4 *v1) {
  return (struct vec4 *)vec4_divide((mfloat_t *)result, (mfloat_t *)v0,
                                    (mfloat_t *)v1);
}
...
struct vec4 *psvec4_clamp(struct vec4 *result, struct vec4 *v0, struct vec4 *v1,
                          struct vec4 *v2) {
...
struct vec4 *psvec4_lerp(struct vec4 *result, struct vec4 *v0, struct vec4 *v1,
                         mfloat_t f) {
  return (struct vec4 *)vec4_lerp((mfloat_t *)result, (mfloat_t *)v0,
                                  (mfloat_t *)v1, f);
}

bool psquat_is_zero(struct quat *q0) { return quat_is_zero((mfloat_t *)q0); }

bool psquat_is_equal(struct quat *q0, struct quat *q1) {
  return quat_is_equal((mfloat_t *)q0, (mfloat_t *)q1);
}

struct quat *psquat(struct quat *result, mfloat_t x, mfloat_t y, mfloat_t z,
                    mfloat_t w) {
...
struct quat *psquat_multiply(struct quat *result, struct quat *q0,
                             struct quat *q1) {
  return (struct quat *)quat_multiply((mfloat_t *)result, (mfloat_t *)q0,
                                      (mfloat_t *)q1);
}
...
struct quat *psquat_from_axis_angle(struct quat *result, struct vec3 *v0,
                                    mfloat_t angle) {
  return (struct quat *)quat_from_axis_angle((mfloat_t *)result, (mfloat_t *)v0,
                                             angle);
}

struct quat *psquat_from_vec3(struct quat *result, struct vec3 *v0,
                              struct vec3 *v1) {
  return (struct quat *)quat_from_vec3((mfloat_t *)result, (mfloat_t *)v0,
                                       (mfloat_t *)v1);
}
...
struct quat *psquat_lerp(struct quat *result, struct quat *q0, struct quat *q1,
                         mfloat_t f) {
  return (struct quat *)quat_lerp((mfloat_t *)result, (mfloat_t *)q0,
                                  (mfloat_t *)q1, f);
}

struct quat *psquat_slerp(struct quat *result, struct quat *q0, struct quat *q1,
                          mfloat_t f) {
  return (struct quat *)quat_slerp((mfloat_t *)result, (mfloat_t *)q0,
                                   (mfloat_t *)q1, f);
}

mfloat_t psquat_length(struct quat *q0) { return quat_length((mfloat_t *)q0); }
...
struct mat2 *psmat2_multiply(struct mat2 *result, struct mat2 *m0,
                             struct mat2 *m1) {
  return (struct mat2 *)mat2_multiply((mfloat_t *)result, (mfloat_t *)m0,
                                      (mfloat_t *)m1);
}
...
struct mat2 *psmat2_lerp(struct mat2 *result, struct mat2 *m0, struct mat2 *m1,
                         mfloat_t f) {
...
struct mat3 *psmat3(struct mat3 *result, mfloat_t m11, mfloat_t m12,
  ...
  return (struct mat3 *)mat3((mfloat_t *)result, m11, m12, m13, m21, m22, m23,
                             m31, m32, m33);
}
...
struct mat3 *psmat3_multiply(struct mat3 *result, struct mat3 *m0,
                             struct mat3 *m1) {
  return (struct mat3 *)mat3_multiply((mfloat_t *)result, (mfloat_t *)m0,
                                      (mfloat_t *)m1);
}
...
struct mat4 *psmat4(struct mat4 *result, mfloat_t m11, mfloat_t m12,
  ...
  return (struct mat4 *)mat4((mfloat_t *)result, m11, m12, m13, m14, m21, m22,
...
struct mat4 *psmat4_rotation_axis(struct mat4 *result, struct vec3 *v0,
                                  mfloat_t f) {
  return (struct mat4 *)mat4_rotation_axis((mfloat_t *)result, (mfloat_t *)v0,
                                           f);
}
...
struct mat4 *psmat4_translation(struct mat4 *result, struct mat4 *m0,
                                struct vec3 *v0) {
  return (struct mat4 *)mat4_translation((mfloat_t *)result, (mfloat_t *)m0,
                                         (mfloat_t *)v0);
}

struct mat4 *psmat4_translate(struct mat4 *result, struct mat4 *m0,
                              struct vec3 *v0) {
  return (struct mat4 *)mat4_translate((mfloat_t *)result, (mfloat_t *)m0,
                                       (mfloat_t *)v0);
}

struct mat4 *psmat4_scaling(struct mat4 *result, struct mat4 *m0,
                            struct vec3 *v0) {
  return (struct mat4 *)mat4_scaling((mfloat_t *)result, (mfloat_t *)m0,
                                     (mfloat_t *)v0);
}
...
struct mat4 *psmat4_multiply(struct mat4 *result, struct mat4 *m0,
                             struct mat4 *m1) {
  return (struct mat4 *)mat4_multiply((mfloat_t *)result, (mfloat_t *)m0,
                                      (mfloat_t *)m1);
}
...
struct mat4 *psmat4_lerp(struct mat4 *result, struct mat4 *m0, struct mat4 *m1,
                         mfloat_t f) {
...
struct mat4 *psmat4_look_at(struct mat4 *result, struct vec3 *position,
  ...
  return (struct mat4 *)mat4_look_at((mfloat_t *)result, (mfloat_t *)position,
...
struct mat4 *psmat4_perspective(struct mat4 *result, mfloat_t fov_y,
  ...
  return (struct mat4 *)mat4_perspective((mfloat_t *)result, fov_y, aspect, n,
                                         f);
}
...
struct mat4 *psmat4_perspective_fov(struct mat4 *result, mfloat_t fov,
                                    ...
                                    mfloat_t f) {
  return (struct mat4 *)mat4_perspective_fov((mfloat_t *)result, fov, w, h, n,
                                             f);
}

struct mat4 *psmat4_perspective_infinite(struct mat4 *result, mfloat_t fov_y,
                                         mfloat_t aspect, mfloat_t n) {
  return (struct mat4 *)mat4_perspective_infinite((mfloat_t *)result, fov_y,
                                                  aspect, n);
}
#endif
#endif
